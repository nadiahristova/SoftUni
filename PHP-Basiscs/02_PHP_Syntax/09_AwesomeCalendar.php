<!--The program has it's limitations. It depends on the reliability of the mktime() function. In other words the program won't work with years below 1902 and beyond 2038+; -->
<?php
$day = 1;
$weeks = 0;
$currWeek = 1;
